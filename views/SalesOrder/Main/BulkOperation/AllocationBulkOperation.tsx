...
interface AllocationBulkOperationProps {
  className?: string;
  open: boolean;
...
const AllocationBulkOperation: FC<AllocationBulkOperationProps> = ({
  className,
  open,
  selectedLineItems,
  shippable,
...
AllocationBulkOperation.propTypes = {
  className: PropTypes.string,
  open: PropTypes.bool,
  //selectedLots: PropTypes.array.isRequired
};

AllocationBulkOperation.defaultProps = {
  open: false
};

export default AllocationBulkOperation;
