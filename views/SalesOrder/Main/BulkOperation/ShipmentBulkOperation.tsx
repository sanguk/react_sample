...
interface ShipmentBulkOperationProps {
  className?: string;
  open: boolean;
...
const ShipmentBulkOperation: FC<ShipmentBulkOperationProps> = ({
  className,
  open,
  selectedLineItems,
...
ShipmentBulkOperation.propTypes = {
  className: PropTypes.string,
  open: PropTypes.bool,
  //selectedLots: PropTypes.array.isRequired
};

ShipmentBulkOperation.defaultProps = {
  open: false
};

export default ShipmentBulkOperation;